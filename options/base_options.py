...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default='/mnt/SSD/d.savinkina/uni/diplom/pytorch-CycleGAN-and-pix2pix/datasets/day2night/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--batch_size', type=int, default=1, help='input batch size')
        parser.add_argument('--loadSizey', type=int, default=350, help='scale images to this size')
        parser.add_argument('--fineSizey', type=int, default=320, help='then crop to this size')
        parser.add_argument('--loadSizex', type=int, default=210, help='scale images to this size')
        parser.add_argument('--fineSizex', type=int, default=180, help='then crop to this size')
